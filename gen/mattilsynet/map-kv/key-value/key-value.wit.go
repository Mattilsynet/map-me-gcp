...
// Package keyvalue represents the imported interface "mattilsynet:map-kv/key-value@0.2.0".
package keyvalue
...
// KeyValueEntry represents the type alias "mattilsynet:map-kv/key-value@0.2.0#key-value-entry".
//
